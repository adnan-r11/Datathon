...
plot(LBN_country$date, LBN_country$retail_and_recreation_percent_change_from_baseline,las = 2, xlab = "Date", ylab = 
       "Percentage change in Retail and Recreation Activities", main = "Effect of COVID-19 in Lebanon") 

plot(LBN_country$date, LBN_country$workplaces_percent_change_from_baseline,las = 2, xlab = "Date", ylab = 
       "Percentage change in Workplaces", main = "Effect of COVID-19 in Lebanon") 

plot(LBN_country$date, LBN_country$residential_percent_change_from_baseline,las = 2, xlab = "Date", ylab = 
       "Percentage change in Household Time", main = "Effect of COVID-19 in Lebanon") 


geom_point(aes(x = LBN_country$date, y = LBN_country$retail_and_recreation_percent_change_from_baseline, col = 2)) 

+
  geom_point(aes(x = LBN_country$date, y = LBN_country$residential_percent_change_from_baseline, col = 1 )) +
  geom_point(aes(x = LBN_country$date, y = LBN_country$workplaces_percent_change_from_baseline, col = 3 )) 

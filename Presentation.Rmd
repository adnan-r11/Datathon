---
title: "Effectiveness of government response of COVID-19"
output:
...
##Retail and Recreation Effect World Average
```{r}

plot(Q$Group.1, Q$retail_and_recreation_percent_change_from_baseline,las = 2, ylab = 
       "Percentage change", main = "COVID-19 Effect on Retail and Recreation overall")
      title(xlab="Week", line=-1, cex.lab=1.2)
      abline(lm(Q$retail_and_recreation_percent_change_from_baseline ~ as.numeric(Q$Group.1)), col = "Blue", lwd =2)
```

##Workplace Effect World Average
```{r}
plot(Q$Group.1, Q$workplaces_percent_change_from_baseline,las = 2, ylab = 
       "Percentage change in Workplaces", main = "COVID-19 Effect on Workplaces overrall") 
title(xlab="Week", line=-1, cex.lab=1.2)
abline(lm(Q$workplaces_percent_change_from_baseline ~ as.numeric(Q$Group.1)), col = "Blue", lwd =2)
```
##Household
```{r}
plot(Q$Group.1, Q$residential_percent_change_from_baseline,las = 2, ylab = 
       "Percentage change in Household Time", main = "COVID-19 Effect on households overall") 
title(xlab="Week", line=-1, cex.lab=1.2)
abline(lm(Q$residential_percent_change_from_baseline ~ as.numeric(Q$Group.1)), col = "Blue", lwd =2)
